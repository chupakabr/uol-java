...
{
    public void test( MutableArray array )
    {
        // create two tasks to write to the shared SimpleArray
        ArrayWriter writer1 = new ArrayWriter( 'a', array );
        ArrayWriter writer2 = new ArrayWriter( 'P', array );
        ...
        try
        {
            ...
            if ( tasksEnded )
                System.out.println( array ); // print contents
            else
                System.out.println(
